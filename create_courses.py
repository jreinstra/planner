...
def populate_departments():
    schools = get_xml_s("http://explorecourses.stanford.edu/?view=xml-20120105")
...
def populate_courses():
    ...
    #print dept_codes
    courses = get_xml_f("http://explorecourses.stanford.edu/search?view=xml-20140630&filter-coursestatus-Active=on&page=0&catalog=&q=AA")
